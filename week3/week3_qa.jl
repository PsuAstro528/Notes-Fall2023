...
- I'll be going through project proposals over next week.
- If working in pairs, let me know with who.
- Sign up for [project presentation schedule](https://github.com/PsuAstro528/PresentationsSchedule2023)

"""

# ╔═╡ 6e8d1601-7ad1-4579-863a-9d10ecfb9ed2
md"""
## Maximizing value of lab time
- I want to encourage students to seek help and practice helping each other.
- At the same time, some students found it difficult to concentrate.   

Options:
  - Ask everyone to use library voice during labs
  - Spreading out over a second room (Davey 432 avaliable)
  - Switching to make Mondays become our lab days (in Davey 538)

What would class like to try next?
"""
...
# ╔═╡ 618ec2e8-6f8e-40e0-b54c-1c93e4e0f054
md"""
...
# ╔═╡ b0ad284d-5ff5-46fa-99f2-f1322ab57518
md"""
### Frequent Testing
...
- Setup continuous integration testing to automate tests
"""
...
![Scientific Computing Language Comparison](https://storopoli.io/Bayesian-Julia/pages/images/language_comparisons.svg)
"""

# ╔═╡ 22be7ad6-32d0-41e9-9a46-c9f530003623
md"""
## Quantitative Performance Comparisons for Microbenchmarks
![Microbenchmarks for common programming languages](https://juliadatascience.io/images/benchmarks.png)
...
- __Interpretted__ langauages: Interactive, but $\sim10-10^3\times$ slower run times
- __Julia__:  Just-In-Time Compiled combines best of both
"""
...
md"#### → Coding in Julia saves human & computer time!"
...
question_box(md"""
Do you think that scratch arrays are a good idea to implement into function hierarchies, even when the language you use already has memory allocation incorporated into it? 

What would be an example of this in a language like Julia or Python?
""")
...
begin
	...
	local plt = contour(grid,grid,[f([x,y]) for x in grid, y in grid])
	xlabel!(plt, "x")
	ylabel!(plt, "y")
end
...
# ╔═╡ d3bebe84-0123-4336-8771-c18b3020d6a2
question_box(md"""
What does Julia's garbage collection look like?
""")
...
# ╔═╡ adf2187c-7a73-4946-bf0b-970d784e6dc3
md"""
### More questions about scaling of algorithms
"""
...
md"""
Is this [memory allocation] done automatically in Python? How about in Julia?
"""
...
# ╔═╡ 577ce1aa-90da-433e-b9cf-be48ef8f34dd
question_box(md"""
Are there any cases where using multiple programming languages for a project is actually preferred (more optimized)

or 

Is it always just to accommodate teams that have people more comfortable with different languages or when combining software originally written in different languages?
""")

# ╔═╡ 59cc826c-ef07-4cdf-8034-80a313722855
md"## Documentation"

# ╔═╡ 2291a5eb-e111-4775-94eb-d19ace8618de
md"""
### What to Document?
...
# ╔═╡ 82d6908c-9bdb-4415-a9f6-77ef56b1f75d
md"""
### What's the differnce between documentation & comments?
...
# ╔═╡ 2e6ff2a7-9c71-4929-a46c-5f7dcb1b4a88
md"""
### Documentation generators

- [Documenter.jl](https://github.com/JuliaDocs/Documenter.jl):  Standard for Julia.  Examples & tests become one
...
# ╔═╡ 7153a990-dc31-4155-8305-3d5065d770f0
md"""
#### Updates to Lab 3
```julia
cd directory_with_your_repo
git remote add upstream git@github.com:PsuAstro528/lab3-start.git
